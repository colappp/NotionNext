...
const BLOG = {
  AUTHOR: 'cola', // 作者
  BIO: '一个超级菜的程序员', // 作者简介
  LINK: 'https://notion-blogs-nine.vercel.app/', // 网站地址
  KEYWORDS: 'Notion, 博客, 大数据, 专插本', // 网站关键词 英文逗号隔开
  NOTION_PAGE_ID:
  ...
  CONTACT_EMAIL: 'cola_pp@163.com',
  CONTACT_WEIBO: '',
  CONTACT_TWITTER: '',
  CONTACT_GITHUB: 'https://github.com/colappp/',
  CONTACT_TELEGRAM: '',
  ...
  COMMENT_GISCUS_REPO: process.env.NEXT_PUBLIC_COMMENT_GISCUS_REPO || 'colappp/comment', // 你的Github仓库名 e.g 'tangly1024/NotionNext'
  COMMENT_GISCUS_REPO_ID: process.env.NEXT_PUBLIC_COMMENT_GISCUS_REPO_ID || 'R_kgDOH-Iy0Q', // 你的Github Repo ID e.g ( 設定完 giscus 即可看到 )
  COMMENT_GISCUS_CATEGORY_ID:
    process.env.NEXT_PUBLIC_COMMENT_GISCUS_CATEGORY_ID || 'DIC_kwDOH-Iy0c4CRWjg', // 你的Github Discussions 內的 Category ID ( 設定完 giscus 即可看到 )
